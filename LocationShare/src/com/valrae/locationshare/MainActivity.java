...
public class MainActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // initiate MapManger 
        try {
            mManager = new MapManager(((MapFragment) getFragmentManager().
                    findFragmentById(R.id.map)).getMap());
        } catch (Exception e) {
            Log.e("MainActivity", "Failed to init MapManager");
            mManager = null;
            e.printStackTrace();
        }
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position) {
            case 1: // update state
                ...
                break;
            case 2: // remove current friend
                // immitate gCalendar
                break;
            case 3: // remove current friend
                // immitate gCalendar
                break;
            case 4: // remove current friend
                // immitate gCalendar
                break;
        }
    }
